...
import VolumeDiscountSelection from "../VolumeDiscountSelection";
import themeColor from "../themeColors";
import FooterInOfferPage from "./FooterInOfferPage";

const MixAndMatchOffer = () => {
  ...
  return (
    <>
        ...
        <div className="flex grid grid-cols-3 mt-5 gap-4 md:grid-cols-3">
          <div className="col-span-2 border-solid border-2 border-clay-500 ml-2 contentDiv mb-20">
            <div className="headSection flex w-full h-11 bg-[#f0ffff]">
              ...
              <h4 className="text-lg text-bold p-2">Mix And Macth Discount</h4>
            </div>
            ...
            <label
              ...
              <div className="offerSelect my-3">
                <label
                  htmlFor="offerTitle"
                  className="block mb-2 text-xl text-bold font-medium text-gray-900 dark:text-white"
                >
                ...
                <div className="flex items-center ml-4 mb-2">
                  <input
                    id="all_product_radio"
                    type="radio"
                    name="bundle_disc"
                    onChange={(e) => handleOffers("all_products")}
                    className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                    checked={offerStatus === "all_products"}
                  />
                  <label
                    htmlFor="all_product_radio"
                ...
                {offerStatus === "all_products" && (
                  <>
                    <div className="all_products_box my-2 ml-6">
                      <div className="flex items-center mb-4">
                        <input
                          ...
                          onClick={(e) => handleExcludeProduct()}
                        />
                        <label
                ...
                {excludeProductChecked && offerStatus === "all_products" && (
                  <>
                    <div className="relative w-full my-4 ml-4">
                ...
                <div className="flex items-center ml-4 mb-2">
                  <input
                    id="specific_product_radio"
                    type="radio"
                    name="bundle_disc"
                    onChange={(e) => handleOffers("specific_products")}
                    className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                    checked={offerStatus === "specific_products"}
                  />
                  <label
                    htmlFor="specific_product_radio"
                    className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 focus:outline-none"
                  >
                    Specific products
                  </label>
                ...
                <div className="flex items-center ml-4 mb-2">
                  <input
                    id="specific_collections_radio"
                    type="radio"
                    name="bundle_disc"
                    onChange={(e) => handleOffers("specific_collections")}
                    className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                    checked={offerStatus === "specific_collections"}
                  />
                  <label
                    htmlFor="specific_collections_radio"
                    className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 focus:outline-none"
                  >
                ...
                {offerStatus === "specific_collections" && (
                  <>
                    <div className="relative w-full my-4 ml-4">
                      <div className="absolute inset-y-0 left-3 flex items-center pl-1 pointer-events-none">
                        <svg
      ...
      <FooterInOfferPage page="MixAndMatch_Offer"/>
    </>
  );
};

export default MixAndMatchOffer;
